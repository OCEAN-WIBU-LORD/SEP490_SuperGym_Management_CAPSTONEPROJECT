...
import com.example.sep490_supergymmanagement.models.Record;
...
import com.example.sep490_supergymmanagement.repositories.RecordResp;
...
import com.example.sep490_supergymmanagement.utils.Utils;
    ...
    private void initViewsUser() {
        ...
        appointmentResp.getAppointmentById(appointmentId, new Callback<Appointment>() {
            ...
            public void onCallback(List<Appointment> appointmentList) {
                ...
                new TrainerResp().getDoctorById(doctorId, new Callback<com.example.sep490_supergymmanagement.models.Trainer>() {
                    @Override
                    public void onCallback(List<com.example.sep490_supergymmanagement.models.Trainer> doctorList) {
